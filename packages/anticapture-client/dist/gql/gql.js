...
const documents = {
    ...
    "query ListOffchainProposals($skip: NonNegativeInt, $limit: PositiveInt, $orderDirection: queryInput_offchainProposals_orderDirection, $status: JSON, $fromDate: Float, $endDate: Float) {\n  offchainProposals(\n    skip: $skip\n    limit: $limit\n    orderDirection: $orderDirection\n    status: $status\n    fromDate: $fromDate\n    endDate: $endDate\n  ) {\n    items {\n      id\n      title\n      discussion\n      link\n      state\n      created\n      end\n    }\n    totalCount\n  }\n}": types.ListOffchainProposalsDocument,
    ...
    "query ListOffchainVotes($fromDate: Float, $toDate: Float, $limit: Float, $skip: NonNegativeInt, $orderBy: queryInput_votesOffchain_orderBy, $orderDirection: queryInput_votesOffchain_orderDirection, $voterAddresses: JSON) {\n  votesOffchain(\n    fromDate: $fromDate\n    toDate: $toDate\n    limit: $limit\n    skip: $skip\n    orderBy: $orderBy\n    orderDirection: $orderDirection\n    voterAddresses: $voterAddresses\n  ) {\n    items {\n      voter\n      created\n      proposalId\n      proposalTitle\n      reason\n      vp\n    }\n    totalCount\n  }\n}": types.ListOffchainVotesDocument,
