...
type Documents = {
    ...
    "query ProposalNonVoters($id: String!, $addresses: JSON, $limit: PositiveInt, $skip: NonNegativeInt, $orderDirection: queryInput_proposalNonVoters_orderDirection) {\n  proposalNonVoters(\n    id: $id\n    addresses: $addresses\n    limit: $limit\n    skip: $skip\n    orderDirection: $orderDirection\n  ) {\n    items {\n      voter\n      votingPower\n      lastVoteTimestamp\n      votingPowerVariation\n    }\n    totalCount\n  }\n}": typeof types.ProposalNonVotersDocument;
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export declare function graphql(source: "query ProposalNonVoters($id: String!, $addresses: JSON, $limit: PositiveInt, $skip: NonNegativeInt, $orderDirection: queryInput_proposalNonVoters_orderDirection) {\n  proposalNonVoters(\n    id: $id\n    addresses: $addresses\n    limit: $limit\n    skip: $skip\n    orderDirection: $orderDirection\n  ) {\n    items {\n      voter\n      votingPower\n      lastVoteTimestamp\n      votingPowerVariation\n    }\n    totalCount\n  }\n}"): (typeof documents)["query ProposalNonVoters($id: String!, $addresses: JSON, $limit: PositiveInt, $skip: NonNegativeInt, $orderDirection: queryInput_proposalNonVoters_orderDirection) {\n  proposalNonVoters(\n    id: $id\n    addresses: $addresses\n    limit: $limit\n    skip: $skip\n    orderDirection: $orderDirection\n  ) {\n    items {\n      voter\n      votingPower\n      lastVoteTimestamp\n      votingPowerVariation\n    }\n    totalCount\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export declare function graphql(source: "query ListVotingPowerHistorys($where: votingPowerHistoryFilter, $limit: Int, $orderBy: String, $orderDirection: String) {\n  votingPowerHistorys(\n    where: $where\n    limit: $limit\n    orderBy: $orderBy\n    orderDirection: $orderDirection\n  ) {\n    items {\n      accountId\n      timestamp\n      votingPower\n      delta\n      daoId\n      transactionHash\n      delegation {\n        delegatorAccountId\n        delegatedValue\n      }\n      transfer {\n        amount\n        fromAccountId\n        toAccountId\n      }\n    }\n  }\n}"): (typeof documents)["query ListVotingPowerHistorys($where: votingPowerHistoryFilter, $limit: Int, $orderBy: String, $orderDirection: String) {\n  votingPowerHistorys(\n    where: $where\n    limit: $limit\n    orderBy: $orderBy\n    orderDirection: $orderDirection\n  ) {\n    items {\n      accountId\n      timestamp\n      votingPower\n      delta\n      daoId\n      transactionHash\n      delegation {\n        delegatorAccountId\n        delegatedValue\n      }\n      transfer {\n        amount\n        fromAccountId\n        toAccountId\n      }\n    }\n  }\n}"];
