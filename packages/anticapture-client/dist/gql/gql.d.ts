...
type Documents = {
    ...
    "query ListHistoricalVotingPower($limit: PositiveInt, $skip: NonNegativeInt, $orderBy: queryInput_historicalVotingPower_orderBy, $orderDirection: queryInput_historicalVotingPower_orderDirection, $fromDate: String, $accountId: String) {\n  historicalVotingPower(\n    limit: $limit\n    skip: $skip\n    orderBy: $orderBy\n    orderDirection: $orderDirection\n    fromDate: $fromDate\n    accountId: $accountId\n  ) {\n    items {\n      accountId\n      timestamp\n      votingPower\n      delta\n      daoId\n      transactionHash\n      delegation {\n        from\n        to\n        value\n        previousDelegate\n      }\n      transfer {\n        from\n        to\n        value\n      }\n    }\n    totalCount\n  }\n}": typeof types.ListHistoricalVotingPowerDocument;
};
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export declare function graphql(source: "query ListVotesOnchains($daoId: String!, $proposalId_in: [String!], $voterAccountId_in: [String!], $timestamp_gt: BigInt, $timestamp_gte: BigInt, $timestamp_lt: BigInt, $timestamp_lte: BigInt, $limit: Int, $orderBy: String, $orderDirection: String) {\n  votesOnchains(\n    where: {daoId: $daoId, proposalId_in: $proposalId_in, voterAccountId_in: $voterAccountId_in, timestamp_gt: $timestamp_gt, timestamp_gte: $timestamp_gte, timestamp_lt: $timestamp_lt, timestamp_lte: $timestamp_lte}\n    limit: $limit\n    orderBy: $orderBy\n    orderDirection: $orderDirection\n  ) {\n    items {\n      daoId\n      txHash\n      proposalId\n      voterAccountId\n      support\n      votingPower\n      timestamp\n      reason\n      proposal {\n        description\n      }\n    }\n    totalCount\n  }\n}"): (typeof documents)["query ListVotesOnchains($daoId: String!, $proposalId_in: [String!], $voterAccountId_in: [String!], $timestamp_gt: BigInt, $timestamp_gte: BigInt, $timestamp_lt: BigInt, $timestamp_lte: BigInt, $limit: Int, $orderBy: String, $orderDirection: String) {\n  votesOnchains(\n    where: {daoId: $daoId, proposalId_in: $proposalId_in, voterAccountId_in: $voterAccountId_in, timestamp_gt: $timestamp_gt, timestamp_gte: $timestamp_gte, timestamp_lt: $timestamp_lt, timestamp_lte: $timestamp_lte}\n    limit: $limit\n    orderBy: $orderBy\n    orderDirection: $orderDirection\n  ) {\n    items {\n      daoId\n      txHash\n      proposalId\n      voterAccountId\n      support\n      votingPower\n      timestamp\n      reason\n      proposal {\n        description\n      }\n    }\n    totalCount\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export declare function graphql(source: "query ListHistoricalVotingPower($limit: PositiveInt, $skip: NonNegativeInt, $orderBy: queryInput_historicalVotingPower_orderBy, $orderDirection: queryInput_historicalVotingPower_orderDirection, $fromDate: String, $accountId: String) {\n  historicalVotingPower(\n    limit: $limit\n    skip: $skip\n    orderBy: $orderBy\n    orderDirection: $orderDirection\n    fromDate: $fromDate\n    accountId: $accountId\n  ) {\n    items {\n      accountId\n      timestamp\n      votingPower\n      delta\n      daoId\n      transactionHash\n      delegation {\n        from\n        to\n        value\n        previousDelegate\n      }\n      transfer {\n        from\n        to\n        value\n      }\n    }\n    totalCount\n  }\n}"): (typeof documents)["query ListHistoricalVotingPower($limit: PositiveInt, $skip: NonNegativeInt, $orderBy: queryInput_historicalVotingPower_orderBy, $orderDirection: queryInput_historicalVotingPower_orderDirection, $fromDate: String, $accountId: String) {\n  historicalVotingPower(\n    limit: $limit\n    skip: $skip\n    orderBy: $orderBy\n    orderDirection: $orderDirection\n    fromDate: $fromDate\n    accountId: $accountId\n  ) {\n    items {\n      accountId\n      timestamp\n      votingPower\n      delta\n      daoId\n      transactionHash\n      delegation {\n        from\n        to\n        value\n        previousDelegate\n      }\n      transfer {\n        from\n        to\n        value\n      }\n    }\n    totalCount\n  }\n}"];
