...
type Documents = {
    ...
    "query GetProposalById($id: String!) {\n  proposal(id: $id) {\n    id\n    daoId\n    proposerAccountId\n    title\n    description\n    startBlock\n    endBlock\n    endTimestamp\n    timestamp\n    status\n    forVotes\n    againstVotes\n    abstainVotes\n  }\n}\n\nquery ListProposals($skip: NonNegativeInt, $limit: PositiveInt, $orderDirection: queryInput_proposals_orderDirection, $status: JSON, $fromDate: Float) {\n  proposals(\n    skip: $skip\n    limit: $limit\n    orderDirection: $orderDirection\n    status: $status\n    fromDate: $fromDate\n  ) {\n    items {\n      id\n      daoId\n      proposerAccountId\n      title\n      description\n      startBlock\n      endBlock\n      endTimestamp\n      timestamp\n      status\n      forVotes\n      againstVotes\n      abstainVotes\n    }\n  }\n}": typeof types.GetProposalByIdDocument;
    "query ListVotesOnchains($daoId: String!, $proposalId_in: [String!], $voterAccountId_in: [String!]) {\n  votesOnchains(\n    where: {daoId: $daoId, proposalId_in: $proposalId_in, voterAccountId_in: $voterAccountId_in}\n  ) {\n    items {\n      txHash\n      proposalId\n      voterAccountId\n      support\n      votingPower\n      timestamp\n    }\n    totalCount\n  }\n}": typeof types.ListVotesOnchainsDocument;
