...
export declare enum DaysWindow {
    '7d' = "_7d",
    '30d' = "_30d",
    '90d' = "_90d",
    '180d' = "_180d",
...
export declare enum QueryInput_OffchainProposals_Status_Items {
    Active = "active",
    Closed = "closed",
    Pending = "pending"
}
...
export declare enum QueryInput_Transactions_AffectedSupply_Items {
    Cex = "CEX",
    Dex = "DEX",
    Lending = "LENDING",
    Total = "TOTAL",
...
export declare enum QueryInput_Transactions_Includes_Items {
    Delegation = "DELEGATION",
    Transfer = "TRANSFER"
}
/** Field used to sort transfers. */
export declare enum QueryInput_Transfers_OrderBy {
    Amount = "amount",
    Timestamp = "timestamp"
}
