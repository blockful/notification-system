...
export enum QueryInput_HistoricalDelegations_OrderDirection {
  Asc = 'asc',
  Desc = 'desc'
}
...
export enum QueryInput_HistoricalVotingPowerByAccountId_OrderDirection {
  Asc = 'asc',
  Desc = 'desc'
}
...
export enum QueryInput_Votes_OrderDirection {
  Asc = 'asc',
  Desc = 'desc'
}
...
export type GetEventRelevanceThresholdQuery = { __typename?: 'Query', getEventRelevanceThreshold?: { __typename?: 'getEventRelevanceThreshold_200_response', threshold: string } | null };
...
export type ListOffchainVotesQuery = { __typename?: 'Query', votesOffchain?: { __typename?: 'votesOffchain_200_response', totalCount: number, items: Array<{ __typename?: 'query_votesOffchain_items_items', voter: string, created: number, proposalId: string, proposalTitle: string, reason: string, vp?: number | null } | null> } | null };
