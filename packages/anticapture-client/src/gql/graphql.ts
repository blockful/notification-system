...
export type GetProposalByIdQuery = { __typename?: 'Query', proposalsOnchain?: { __typename?: 'proposalsOnchain', id: string, daoId: string, proposerAccountId: string, targets: any, values: any, signatures: any, calldatas: any, startBlock: number, endBlock: number, endTimestamp: string, description: string, timestamp: string, status: string, forVotes: string, againstVotes: string, abstainVotes: string } | null };
