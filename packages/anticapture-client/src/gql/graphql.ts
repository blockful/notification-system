...
export type GetDaOsQuery = { __typename?: 'Query', daos: { __typename?: 'daoPage', items: Array<{ __typename?: 'dao', id: string, votingDelay: string }> } };
...
export type ListProposalsQuery = { __typename?: 'Query', proposals?: Array<{ __typename?: 'query_proposals_items', id: string, daoId: string, proposerAccountId: string, title?: string | null, description: string, startBlock: number, endBlock: number, endTimestamp: string, timestamp: string, status: string, forVotes: string, againstVotes: string, abstainVotes: string } | null> | null };
...
export type ListVotesOnchainsQuery = { __typename?: 'Query', votesOnchains: { __typename?: 'votesOnchainPage', totalCount: number, items: Array<{ __typename?: 'votesOnchain', txHash?: string | null, proposalId?: string | null, voterAccountId: string, support?: string | null, votingPower?: string | null, timestamp?: string | null }> } };
