...
const batchAddressesBodySchema = z.object({
  ...
  trigger_type: z.string().optional().describe('Filter by notification type preference')
});
...
export class UserAddressController {
  ...
  async register(fastify: FastifyInstance): Promise<void> {
    ...
    fastify.get<{
      ...
      const { trigger_type } = request.query as { trigger_type?: string };
    ...
    fastify.post<{
      ...
      const { addresses, trigger_type } = request.body as { addresses: string[]; trigger_type?: string };
