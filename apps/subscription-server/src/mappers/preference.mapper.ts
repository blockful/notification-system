...
export const toSubscriptionResponse = (
  ...
  created_at: preference.created_at ? preference.created_at.toISOString() : undefined,
  updated_at: preference.updated_at ? preference.updated_at.toISOString() : undefined
}); 